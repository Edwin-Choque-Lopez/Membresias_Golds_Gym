    ...
    <header class="header header--bg">
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-5 header__content">
            <h1 class="title" style="text-align: center">Gimnasio Gold's Gym <br><span class="title-style"></span></h1>
            <p style="text-align: justify">Estamos ubicados en la ciudad de Oruro, Bolivia, en la calle Aroma #536, somos una institución dedicada a promover la salud y el bienestar a través de un servicio de entrenamiento físico de alta calidad. El gimnasio se enfoca en brindar a nuestros clientes un espacio óptimo para que alcanzen sus objetivos.</p>
            <a class="header__button" href="#">Mas Informacón</a>
          ...
          <div class="row">
            <div class="col-md-4">
              <div class="text-center steps__single steps__single-first">
                <img style="width: 80%" src="assets/images/img1.jpg" alt="">
                <p>LOREM IPSUM DOLOR SIT AMET</p>
              </div>
            </div>
            <div class="col-md-4">
              <div class="text-center steps__single">
                <img style="width: 80%" src="assets/images/img2.jpg" alt="">
                <p>LOREM IPSUM DOLOR SIT AMET</p>
              </div>
            </div>
            <div class="col-md-4">
